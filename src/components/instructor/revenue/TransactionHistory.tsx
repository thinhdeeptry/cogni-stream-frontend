...
import { RevenueShare, formatCurrency } from "@/actions/revenueShareActions";
      ...
      <CardContent>
        {isLoading ? (
          ...
          <div className="text-center py-12">
            ...
            <p className="text-slate-500 text-lg mb-2">Chưa có giao dịch nào</p>
            <p className="text-slate-400">
              Giao dịch sẽ xuất hiện khi học viên mua khóa học hoặc lớp học của
              bạn
            </p>
          </div>
        ) : (
