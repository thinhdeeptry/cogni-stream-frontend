...
interface ReportState {
  ...
  updateFormattedData: (reportId: string, formattedData: string) => void;
}
...
const useReportStore = create<ReportState>((set, get) => ({
  ...
  updateFormattedData: (reportId: string, formattedData: string) => {
    const reports = get().reports;
    const updatedReports = reports.map((report) =>
      report.id === reportId ? { ...report, formattedData } : report,
    );
